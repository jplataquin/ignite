...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2 fw-bold text-dark">Edit Division</h1>
...
<div class="row">
    <div class="col-12 col-xl-8">
        <div class="card fd-card p-4 shadow-sm">
            <h5 class="fw-bold mb-3 text-dark">Edit Division Properties</h5>
            <p class="text-muted small mb-4">Update the division name. Note that this change will be reflected across all linked departments.</p>
            ...
            <form method="POST" action="{{ route('admin.divisions.update', $division) }}">
                ...
                <div class="mb-4">
                    ...
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $division->name) }}" required autofocus placeholder="e.g. Technology, Operations, Legal, HR">
                    @error('name')
