...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2 fw-bold text-dark">Divisions</h1>
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{ route('admin.divisions.create') }}" class="btn btn-primary d-flex align-items-center">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 text-end">
                            <div class="d-inline-flex gap-1">
                                <a href="{{ route('admin.divisions.edit', $division) }}" class="btn btn-sm btn-outline-secondary d-flex align-items-center" style="min-height: 34px;">
                                    Edit
                                </a>
                                <form action="{{ route('admin.divisions.destroy', $division) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this division? This cannot be undone.');">
                                    @csrf
                                    @method('DELETE')
