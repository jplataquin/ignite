        ...
        <div class="card fd-card p-4 shadow-sm">
            ...
            <form method="POST" action="{{ route('admin.ticket-types.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input id="assignment_threshold_days" type="number" class="form-control @error('assignment_threshold_days') is-invalid @enderror" name="assignment_threshold_days" value="{{ old('assignment_threshold_days') }}" min="1" placeholder="e.g. 2 (Leave empty for no assignment threshold)">
