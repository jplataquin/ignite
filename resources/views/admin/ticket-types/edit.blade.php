...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2 fw-bold text-dark">Edit Ticket Type</h1>
...
<div class="row">
    <div class="col-12 col-xl-8">
        <div class="card fd-card p-4 shadow-sm">
            ...
            <p class="text-muted small mb-4">Edit the properties for the selected ticket type category.</p>
            ...
            <form method="POST" action="{{ route('admin.ticket-types.update', $ticketType) }}">
                ...
                <div class="mb-3">
                    ...
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $ticketType->name) }}" required autofocus placeholder="e.g. Incident, Service Request, Problem">
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input id="code" type="text" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code', $ticketType->code) }}" required placeholder="e.g. AUD, TCK, INC" maxlength="3" minlength="3" style="text-transform: uppercase;">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description" rows="3" placeholder="Provide a brief description of what this ticket type represents...">{{ old('description', $ticketType->description) }}</textarea>
                    @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
