...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2 fw-bold text-dark">Create Role</h1>
...
<div class="row">
    <div class="col-12 col-xl-8">
        <div class="card fd-card p-4 shadow-sm">
            ...
            <p class="text-muted small mb-4">Define a new user role with specific privileges and ownership properties across departments and divisions.</p>
            ...
            <form method="POST" action="{{ route('admin.roles.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autofocus placeholder="e.g. IT Engineer, HR Generalist, Support Lead">
                    @error('name')
