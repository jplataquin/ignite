...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2 fw-bold text-dark">Departments</h1>
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{ route('admin.departments.create') }}" class="btn btn-primary d-flex align-items-center">
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                @forelse($departments as $department)
                    <tr>
                        ...
                        <td class="py-3 text-muted">
                            <span class="badge bg-light text-dark border px-3 py-2 fw-semibold">{{ $department->division->name ?? 'None' }}</span>
                        </td>
                        ...
                        <td class="px-4 py-3 text-end">
                            <div class="d-inline-flex gap-1">
                                <a href="{{ route('admin.departments.edit', $department) }}" class="btn btn-sm btn-outline-secondary d-flex align-items-center" style="min-height: 34px;">
                                    Edit
                                </a>
                                <form action="{{ route('admin.departments.destroy', $department) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this department? This cannot be undone.');">
                                    @csrf
                                    @method('DELETE')
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center py-5 text-muted">No departments found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
