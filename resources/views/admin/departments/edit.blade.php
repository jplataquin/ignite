...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2 fw-bold text-dark">Edit Department</h1>
...
<div class="row">
    <div class="col-12 col-xl-8">
        <div class="card fd-card p-4 shadow-sm">
            <h5 class="fw-bold mb-3 text-dark">Edit Department Properties</h5>
            <p class="text-muted small mb-4">Modify department details or reassign it to a different parent structural division.</p>
            ...
            <form method="POST" action="{{ route('admin.departments.update', $department) }}">
                ...
                <div class="mb-3">
                    ...
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $department->name) }}" required autofocus placeholder="e.g. Software Engineering, Customer Success, Accounting">
                    @error('name')
