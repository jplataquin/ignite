...
<div class="row">
    <div class="col-12 col-xl-8">
        <div class="card fd-card p-4 shadow-sm">
            <h5 class="fw-bold mb-3 text-dark">SLA Configurations</h5>
            <p class="text-muted small mb-4">Define the operational service level agreement (SLA) threshold durations in days. These rules determine the deadline dates for completing support tickets based on their priority level.</p>
