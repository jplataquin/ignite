...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2 fw-bold text-dark">Create Ticket Stage</h1>
...
<div class="row">
    <div class="col-12 col-xl-8">
        <div class="card fd-card p-4 shadow-sm">
            <h5 class="fw-bold mb-3 text-dark">Stage Properties</h5>
            <p class="text-muted small mb-4">Define a new operational state for support tickets. Ensure the color represents the state clearly (e.g. green for completed, yellow for initial review).</p>

            <form method="POST" action="{{ route('admin.ticket-stages.store') }}">
                @csrf
                ...
                <div class="d-flex justify-content-end gap-2 border-top pt-4">
                    ...
                    <button type="submit" class="btn btn-primary px-4">Create Stage</button>
                </div>
            </form>
        </div>
    </div>
